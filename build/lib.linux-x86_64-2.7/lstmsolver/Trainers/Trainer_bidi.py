#!/usr/bin/python 
'''Module that acts on inputs and the same input time reversed and gives you the required output. The module is subclassed from the original Trainer module'''
from Trainer import *

class Trainer_bidi(Trainer):
    ...
    def predict_image(self,x):
        ...
        #image_pred=(pred[:,:self.width]+pred[:,self.width:])/2.0
        return pred
